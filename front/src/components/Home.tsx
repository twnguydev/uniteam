            ...
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto min-h-screen lg:py-0">
                ...
                <div className="flex flex-col sm:flex-row justify-around gap-4 m-8">
                    ...
                    <div className="block max-w-xl p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                        ...
                        <p className="font-normal text-gray-700">Découvrez une solution flexible conçue pour répondre à vos besoins spécifiques. Grâce à <b>Uniteam</b>, maximisez l'efficacité de vos infrastructures et assurez une gestion transparente de vos salles d'entreprise.</p>
                    </div>
                </div>
            </div>
        </section>
